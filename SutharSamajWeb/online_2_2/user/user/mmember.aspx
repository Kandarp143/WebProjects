<%@ Page Language="C#" MasterPageFile="~/user/user/UserMasterPage.master" AutoEventWireup="true" CodeFile="mmember.aspx.cs" Inherits="user_member2" Title="::SAMAJ::" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <tr>
    <td style="vertical-align: top; width: 130px;"><asp:Image ID="Image1" runat="server" ImageUrl="~/Images/memberphoto.jpg" Height="120pt" Width="100pt" BorderColor="#9999FF" BorderStyle="Solid" BorderWidth="2" />
    </td>
        <td>
        <table>
    ...
    <tr>
    <td style="vertical-align: top;width: 130px;"><asp:Image ID="Image1" runat="server" ImageUrl="~/Images/memberphoto.jpg" Height="120pt" Width="100pt" BorderColor="#29547E" BorderStyle="Solid" BorderWidth="2" />
    </td>
        <td>
        <table>
        <tr><td colspan="3"><br /></td></tr>
