<%@ Page Language="C#" MasterPageFile="~/user/user/UserMasterPage.master" AutoEventWireup="true" CodeFile="contactus.aspx.cs" Inherits="user_contactus" Title="::SAMAJ::" %>
    ...
    <tr><td>Email Id:</td><td>
         ...
         <tr><td>Contact No:</td><td>
             <asp:TextBox ID="txtcno" runat="server" Width="173px" BorderColor="#CC6600" BorderStyle="Inset" BorderWidth="2px"></asp:TextBox>
                 ...
                 ErrorMessage="enter 11 digit start with 0" ValidationExpression="(0/d{10})" 
                 ControlToValidate="txtcno">*</asp:RegularExpressionValidator>
                                                </td></tr>
         <tr><td>Your Suggestion:<br />
            ...
            <tr><td colspan="2"><center>
                <asp:Button ID="Button1" runat="server" Text="Submit" BackColor="White" 
                    ...
                    ForeColor="#CC6600" onclick="Button1_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
