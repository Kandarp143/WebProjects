...
$your_email = "hardo91@gmail.com"; // email address to which the form data will be sent
$subject = "Inquery dotapi"; // subject of the email that is sent
...
$error_msg[] = "The Your Query field must contain only letters, digits, spaces and basic punctuation (&nbsp;'&nbsp;-&nbsp;,&nbsp;.&nbsp;), and has a limit of 1000 characters";
}
...
echo '</ul>
	<form method="post" action="', $_SERVER['PHP_SELF'], '">
		<fieldset> 
			<legend>Whats Your Query..</legend>
				<div>
				...
				<div>
					<label for="comm">Your Query</label>
...
<div class="content">
	...
	<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
		<fieldset> 
			<legend>What's Your Query..??</legend>
				<div>
					<label for="name">Name</label>
