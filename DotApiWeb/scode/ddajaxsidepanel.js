...
var ddajaxsidepanel = {
	defaults: {ajaxloadgif:'../images/squareloading.gif', fx:{dur:'normal', easing:'swing'}, openamount:'80%', openamount_minthreshold:'400px'},
...
jQuery(function(){
	ddajaxsidepanel.init({
		...
		openamount:'99.5%', // Width of panel when fully opened (Percentage value relative to page, or pixel value
