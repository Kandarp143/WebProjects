<%@ Page Language="C#" MasterPageFile="~/user/user/UserMasterPage.master" AutoEventWireup="true" CodeFile="addsubmember.aspx.cs" Inherits="user_addsubmember" Title="::SAMAJ::" %>
...
<div style="background-image: url('../../Images/smember_bg.jpg'); height: 632px;">
    
    <table style="padding-top: 75px;padding-left:28px; width: 770px;"><tr>
        <td class="style4">
            <asp:Button ID="btnpersonal" runat="server" 
                Text="Personal Detail" Width="140px" Height="33px" /></td>
        <td><asp:Button ID="btnhome" runat="server" Text="Home Detail" 
                Width="126px" Height="32px" /></td><td>
            <asp:Button ID="btnwork" 
                runat="server" Text="Work Detail" 
                Width="126px" Height="31px"/> </td>
        <td class="style14">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td></tr>
        <tr><td colspan="4">
            ...
            <asp:TextBox ID="txteducation" runat="server" Width="211px"></asp:TextBox>
                ...
                <asp:View ID="View2" runat="server">
                 <table style="border: 2px solid #99CCFF; margin-left: 3px; margin-top :0px; width: 700px;">
                   <tr><td>
                       <asp:Button ID="mcopy1" runat="server" Text="Copy From Main Member" 
                           Font-Names="Bodoni MT" BorderColor="#99CCFF" BorderStyle="Solid" 
                           BorderWidth="2px" Font-Size="12pt" OnClick="mcopy1_Click" /></td></tr><tr>
        <td style="text-align: right; font-family: 'Times New Roman', Times, serif; font-size: 17px; color:#000000" >
            Home Address1:</td>
        <td>
        ...
        <td class="style2">
            &nbsp;</td>
                ...
                <asp:View ID="View3" runat="server">
                             <table style="border: 2px solid #99CCFF; margin-left: 3px; margin-top :0px; width: 700px;">
                   <tr><td>
                       <asp:Button ID="cmain" runat="server" Text="Copy From Main Member" 
                           Font-Names="Bodoni MT" BorderColor="#99CCFF" BorderStyle="Solid" 
                           BorderWidth="2px" Font-Size="12pt" OnClick="cmain_Click" /></td></tr><tr>
        <td style="text-align: right; font-family: 'Times New Roman', Times, serif; font-size: 17px; color:#000000" >
            Profession:</td>
        <td>
